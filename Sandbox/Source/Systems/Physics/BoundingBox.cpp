...
{
	m_points.resize(8);
	m_points[0] = m_min =	m_origin + glm::vec3(-halfSize, -halfSize * 2.0f, -halfSize);
	m_points[3] =			m_origin + glm::vec3(-halfSize, -halfSize * 2.0f,  halfSize);
	m_points[1] =			m_origin + glm::vec3(-halfSize,  halfSize * 2.0f, -halfSize);
	m_points[2] =			m_origin + glm::vec3(-halfSize,  halfSize * 2.0f,  halfSize);
	m_points[5] =			m_origin + glm::vec3( halfSize, -halfSize * 2.0f, -halfSize);
	m_points[6] =			m_origin + glm::vec3( halfSize, -halfSize * 2.0f,  halfSize);
	m_points[4] =			m_origin + glm::vec3( halfSize,  halfSize * 2.0f, -halfSize);
	m_points[7] = m_max =	m_origin + glm::vec3( halfSize,  halfSize * 2.0f,  halfSize);
}
...
bool BoundingBox::Intersect(const BoundingBox& aabb)
{
